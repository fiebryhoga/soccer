...
import { Settings, Plus, Edit2, Trash2, X, Activity, Target, Layers } from 'lucide-react';
...
export default function AssessmentMaster({ auth, categories }) {
    ...
    // is_lower_better dihapus dari form
    const itemForm = useForm({
        id: null, category_id: null, name: '', parameter_type: 'reps', target_benchmark: ''
    });
    ...
    const openItemModal = (item = null) => {
        if (item) {
            itemForm.setData({
                ...
                parameter_type: item.parameter_type, target_benchmark: item.target_benchmark
            });
        } else {
            itemForm.reset();
            itemForm.setData({ category_id: selectedCat.id, parameter_type: 'reps' });
        }
